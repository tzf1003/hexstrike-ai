...
class HexStrikeColors:
    ...
    # 兼容性别名
    BRIGHT_RED = '\033[38;5;196m'       # 亮红色 (与ERROR相同)
    BRIGHT_GREEN = '\033[38;5;46m'      # 亮绿色 (与MATRIX_GREEN相同)
    DIM_WHITE = '\033[38;5;240m'        # 暗白色 (与TERMINAL_GRAY相同)
    NEON_YELLOW = '\033[38;5;226m'      # 霓虹黄色
    NEON_GREEN = '\033[38;5;46m'        # 霓虹绿色 (与MATRIX_GREEN相同)
    NEON_CYAN = '\033[38;5;51m'         # 霓虹青色 (与NEON_BLUE相同)
